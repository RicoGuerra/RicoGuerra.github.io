...
date:   2023-01-12 11:25:52 +0100
categories: Testing
---

# Unreal Engine Style Guide for the VIOLA Project

Style guide created by Github user [Allar](https://github.com/Allar/ue5-style-guide).

## Table of contents
- [Unreal Engine Style Guide for the VIOLA Project](#unreal-engine-style-guide-for-the-viola-project)
  - [Table of contents](#table-of-contents)
  - [Important Terminology](#important-terminology)
        - [Levels/Maps](#levelsmaps)
  ...
  - [0. Principles](#0-principles)
    - [0.1 If your UE4 project already has a style guide, you should follow it](#01-if-your-ue4-project-already-has-a-style-guide-you-should-follow-it)
    - [0.2 All structure, assets, and code in any Unreal Engine 4 project should look like a single person created it, no matter how many people contributed](#02-all-structure-assets-and-code-in-any-unreal-engine-4-project-should-look-like-a-single-person-created-it-no-matter-how-many-people-contributed)
    - [0.3 Friends do not let friends have bad style](#03-friends-do-not-let-friends-have-bad-style)
    - [0.4 A team without a style guide is no team of mine](#04-a-team-without-a-style-guide-is-no-team-of-mine)
    - [0.5 Don't Break The Law](#05-dont-break-the-law)
  - [00. Globally Enforced Opinions](#00-globally-enforced-opinions)
    - [00.1 Forbidden Characters](#001-forbidden-characters)
      - [Identifiers](#identifiers-1)
  - [1. Asset Naming Conventions](#1-asset-naming-conventions)
    - [1.1 Base Asset Name - `Prefix_BaseAssetName_Variant_Suffix`](#11-base-asset-name---prefix_baseassetname_variant_suffix)
      - [1.1 Examples](#11-examples)
        - [1.1e1 Bob](#11e1-bob)
        - [1.1e2 Rocks](#11e2-rocks)
    - [1.2 Asset Name Modifiers](#12-asset-name-modifiers)
    ...
    - [1.2.6 Textures](#126-textures)
      - [1.2.6.1 Texture Packing](#1261-texture-packing)
    - [1.2.7 Miscellaneous](#127-miscellaneous)
    - [1.2.8 Paper 2D](#128-paper-2d)
    - [1.2.9 Physics](#129-physics)
    - [1.2.10 Sounds](#1210-sounds)
    - [1.2.11 User Interface](#1211-user-interface)
    - [1.2.12 Effects](#1212-effects)
  - [2. Content Directory Structure](#2-content-directory-structure)
    - [2e1 Example Project Content Structure](#2e1-example-project-content-structure)
    - [2.1 Folder Names](#21-folder-names)
      - [2.1.1 Always Use PascalCase\*](#211-always-use-pascalcase)
      - [2.1.2 Never Use Spaces](#212-never-use-spaces)
      - [2.1.3 Never Use Unicode Characters And Other Symbols](#213-never-use-unicode-characters-and-other-symbols)
    - [2.2 Use A Top Level Folder For Project Specific Assets](#22-use-a-top-level-folder-for-project-specific-assets)
      - [2.2.1 No Global Assets](#221-no-global-assets)
      - [2.2.2 Reduce Migration Conflicts](#222-reduce-migration-conflicts)
        - [2.2.2e1 Master Material Example](#222e1-master-material-example)
      - [2.2.3 Samples, Templates, and Marketplace Content Are Risk-Free](#223-samples-templates-and-marketplace-content-are-risk-free)
      - [2.2.4 DLC, Sub-Projects, and Patches Are Easily Maintained](#224-dlc-sub-projects-and-patches-are-easily-maintained)
    - [2.3 Use Developers Folder For Local Testing](#23-use-developers-folder-for-local-testing)
    - [2.4 All Map\* Files Belong In A Folder Called Maps](#24-all-map-files-belong-in-a-folder-called-maps)
    - [2.5 Use A `Core` Folder For Critical Blueprints And Other Assets](#25-use-a-core-folder-for-critical-blueprints-and-other-assets)
    - [2.6 Do Not Create Folders Called `Assets` or `AssetTypes`](#26-do-not-create-folders-called-assets-or-assettypes)
      - [2.6.1 Creating a folder named `Assets` is redundant](#261-creating-a-folder-named-assets-is-redundant)
      - [2.6.2 Creating a folder named `Meshes`, `Textures`, or `Materials` is redundant](#262-creating-a-folder-named-meshes-textures-or-materials-is-redundant)
    - [2.7 Very Large Asset Sets Get Their Own Folder Layout](#27-very-large-asset-sets-get-their-own-folder-layout)
    - [2.8 `MaterialLibrary`](#28-materiallibrary)
    - [2.9 No Empty Folders](#29-no-empty-folders)
  - [3. Blueprints](#3-blueprints)
    - [3.1 Compiling](#31-compiling)
    - [3.2 Variables](#32-variables)
      - [3.2.1 Naming](#321-naming)
        - [3.2.1.1 Nouns](#3211-nouns)
        - [3.2.1.2 PascalCase](#3212-pascalcase)
          - [3.2.1.2e Examples](#3212e-examples)
        - [3.2.1.3 Boolean `b` Prefix](#3213-boolean-b-prefix)
        - [3.2.1.4 Boolean Names](#3214-boolean-names)
          - [3.2.1.4.1 General And Independent State Information](#32141-general-and-independent-state-information)
          - [3.2.1.4.2 Complex States](#32142-complex-states)
        - [3.2.1.5 Considered Context](#3215-considered-context)
          - [3.2.1.5e Examples](#3215e-examples)
        - [3.2.1.6 Do _Not_ Include Atomic Type Names](#3216-do-not-include-atomic-type-names)
        - [3.2.1.7 Do Include Non-Atomic Type Names](#3217-do-include-non-atomic-type-names)
        - [3.2.1.8 Arrays](#3218-arrays)
      - [3.2.2 Editable Variables](#322-editable-variables)
        - [3.2.2.1 Tooltips](#3221-tooltips)
        - [3.2.2.2 Slider And Value Ranges](#3222-slider-and-value-ranges)
      - [3.2.3 Categories](#323-categories)
      - [3.2.4 Variable Access Level](#324-variable-access-level)
        - [3.2.4.1 Private Variables](#3241-private-variables)
      - [3.2.5 Advanced Display](#325-advanced-display)
      - [3.2.6 Transient Variables](#326-transient-variables)
      - [3.2.8 Config Variables](#328-config-variables)
    - [3.3 Functions, Events, and Event Dispatchers](#33-functions-events-and-event-dispatchers)
      - [3.3.1 Function Naming](#331-function-naming)
      - [3.3.1.1 All Functions Should Be Verbs](#3311-all-functions-should-be-verbs)
      - [3.3.1.2 Property RepNotify Functions Always `OnRep_Variable`](#3312-property-repnotify-functions-always-onrep_variable)
      - [3.3.1.3 Info Functions Returning Bool Should Ask Questions](#3313-info-functions-returning-bool-should-ask-questions)
      - [3.3.1.4 Event Handlers and Dispatchers Should Start With `On`](#3314-event-handlers-and-dispatchers-should-start-with-on)
      - [3.3.1.5 Remote Procedure Calls Should Be Prefixed With Target](#3315-remote-procedure-calls-should-be-prefixed-with-target)
      - [3.3.2 All Functions Must Have Return Nodes](#332-all-functions-must-have-return-nodes)
      - [3.3.3 No Function Should Have More Than 50 Nodes](#333-no-function-should-have-more-than-50-nodes)
      - [3.3.4 All Public Functions Should Have A Description](#334-all-public-functions-should-have-a-description)
      - [3.3.5 All Custom Static Plugin `BlueprintCallable` Functions Must Be Categorized By Plugin Name](#335-all-custom-static-plugin-blueprintcallable-functions-must-be-categorized-by-plugin-name)
    - [3.4 Blueprint Graphs](#34-blueprint-graphs)
      - [3.4.1 No Spaghetti](#341-no-spaghetti)
      - [3.4.2 Align Wires Not Nodes](#342-align-wires-not-nodes)
      - [3.4.3 White Exec Lines Are Top Priority](#343-white-exec-lines-are-top-priority)
      - [3.4.4 Graphs Should Be Reasonably Commented](#344-graphs-should-be-reasonably-commented)
      - [3.4.5 Graphs Should Handle Casting Errors Where Appropriate](#345-graphs-should-handle-casting-errors-where-appropriate)
      - [3.4.6 Graphs Should Not Have Any Dangling / Loose / Dead Nodes](#346-graphs-should-not-have-any-dangling--loose--dead-nodes)
  - [4. Static Meshes](#4-static-meshes)
    - [4.1 Static Mesh UVs](#41-static-mesh-uvs)
      - [4.1.1 All Meshes Must Have UVs](#411-all-meshes-must-have-uvs)
      - [4.1.2 All Meshes Must Not Have Overlapping UVs for Lightmaps](#412-all-meshes-must-not-have-overlapping-uvs-for-lightmaps)
    - [4.2 LODs Should Be Set Up Correctly](#42-lods-should-be-set-up-correctly)
    - [4.3 Modular Socketless Assets Should Snap To The Grid Cleanly](#43-modular-socketless-assets-should-snap-to-the-grid-cleanly)
    - [4.4 All Meshes Must Have Collision](#44-all-meshes-must-have-collision)
    - [4.5 All Meshes Should Be Scaled Correctly](#45-all-meshes-should-be-scaled-correctly)
  - [5. Niagara](#5-niagara)
    - [5.1 No Spaces, Ever](#51-no-spaces-ever)
  - [6. Levels / Maps](#6-levels--maps)
    ...
    - [6.4 Marketplace Specific Rules](#64-marketplace-specific-rules)
      - [6.4.1 Overview Level](#641-overview-level)
      - [6.4.2 Demo Level](#642-demo-level)
  - [7. Textures](#7-textures)
    ...
    - [7.4 Textures Should Be Grouped Correctly](#74-textures-should-be-grouped-correctly)
